...
<nav class="navbar navbar-fixed-top color-nav">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="../index.php">Eficieciencia Riego</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#../index.php">Inicio</a></li>
                <li id="showModalSobre"><a  href="../index.php">Sobre</a></li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="../index.php#litros">Litros por sector </a></li>                                
                    </ul>
                </li>
                <li class="dropdown">
